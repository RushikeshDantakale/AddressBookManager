...
const createContactSlice = createSlice({
  ...
  reducers: {
    ...
    updateContact(state, action) {
      ...
      console.log(
        action.payload.updatedName,
        action.payload.updatedNumber,
        "cartslice 23 line"
      );
      ...
      else if (action.payload.updatedName !== "") state[index].name = action.payload.updatedName;
      else state[index].number = action.payload.updatedNumber;
    },
  },
});
